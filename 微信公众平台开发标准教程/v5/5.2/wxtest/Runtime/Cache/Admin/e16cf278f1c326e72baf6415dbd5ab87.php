...
<script>
	...
	<script type="text/javascript" src="/wangjialin/action/v5/5.2/wxtest/Public/static/uploadify/jquery.uploadify.min.js"></script>
                        ...
                        <?php switch($field["type"]): case "num": ?><input type="text" class="text input-medium" name="<?php echo ($field["name"]); ?>" value="<?php echo ($field["value"]); ?>"><?php break;?>
                            ...
                            <?php case "picture": ?><div class="controls">
								...
								$("#upload_picture_<?php echo ($field["name"]); ?>").uploadify({
							        "height"          : 30,
							        "swf"             : "/wangjialin/action/v5/5.2/wxtest/Public/static/uploadify/uploadify.swf",
								...
								function uploadPicture<?php echo ($field["name"]); ?>(file, data){
							        ...
							        if(data.status){
							        	...
							        	src = data.url || '/wangjialin/action/v5/5.2/wxtest' + data.path
							        	$("#cover_id_<?php echo ($field["name"]); ?>").parent().find('.upload-img-box').html(
							        		'<div class="upload-pre-item"><img src="/wangjialin/action/v5/5.2/wxtest' + src + '"/></div>'
							        	);
							        } else {
...
<link href="/wangjialin/action/v5/5.2/wxtest/Public/static/datetimepicker/css/datetimepicker.css" rel="stylesheet" type="text/css">
<?php if(C('COLOR_STYLE')=='blue_color') echo '<link href="/wangjialin/action/v5/5.2/wxtest/Public/static/datetimepicker/css/datetimepicker_blue.css" rel="stylesheet" type="text/css">'; ?>
<link href="/wangjialin/action/v5/5.2/wxtest/Public/static/datetimepicker/css/dropdown.css" rel="stylesheet" type="text/css">
<script type="text/javascript" src="/wangjialin/action/v5/5.2/wxtest/Public/static/datetimepicker/js/bootstrap-datetimepicker.min.js"></script>
<script type="text/javascript" src="/wangjialin/action/v5/5.2/wxtest/Public/static/datetimepicker/js/locales/bootstrap-datetimepicker.zh-CN.js" charset="UTF-8"></script>
<script type="text/javascript">
