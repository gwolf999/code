...
--
-- Host: localhost
-- Generation Time: 2016-08-10 15:02:03
-- 服务器版本： 5.5.42
-- PHP Version: 5.6.6
...
(1, 1, 1, 2130706433, 'member', 1, 'admin在2016-08-09 11:14登录了后台', 1, 1470712455),
(2, 10, 1, 2130706433, 'Menu', 122, '操作url：/wangjialin/trunk/action/v5/5.5/photos/index.php?s=/admin/menu/add.html', 1, 1470714452),
(3, 10, 1, 2130706433, 'Menu', 122, '操作url：/wangjialin/trunk/action/v5/5.5/photos/index.php?s=/admin/menu/edit.html', 1, 1470714467),
(4, 10, 1, 2130706433, 'Menu', 123, '操作url：/wangjialin/trunk/action/v5/5.5/photos/index.php?s=/Admin/Menu/add.html', 1, 1470727404);
...
(25, 'LIST_ROWS', 0, '后台每页记录数', 2, '', '后台数据每页显示记录数', 1379503896, 1380427745, 1, '5', 10),
...
CREATE TABLE `db_document_article` (
...
CREATE TABLE `db_document_download` (
  `id` int(10) UNSIGNED NOT NULL DEFAULT '0' COMMENT '文档ID',
  `parse` tinyint(3) UNSIGNED NOT NULL DEFAULT '0' COMMENT '内容解析类型',
...
INSERT INTO `db_file` (`id`, `name`, `savename`, `savepath`, `ext`, `mime`, `size`, `md5`, `sha1`, `location`, `create_time`) VALUES
(1, '6CA32641-BD4E-4E84-9EB1-E785D7', '57a95834b39c4.png', '2016-08-09/', 'png', 'image/jpeg', 220696, '0bd47482141dd5a93f623fc97a1c5a04', '8be74762425b1d556d268c9f60190b03b16ff28d', 0, 1470715956);
...
(1, 'admin', 0, '0000-00-00', '', 10, 2, 0, 1470712443, 2130706433, 1470712455, 1);
...
(122, '图集', 0, 5, 'Photos/index', 0, '', '', 0),
(123, '图集列表', 122, 0, 'Photos/index', 0, '', '图集管理', 0);
...
CREATE TABLE `db_photos` (
  `id` int(4) NOT NULL,
  `img_id` int(10) NOT NULL COMMENT '缩略图id',
...
INSERT INTO `db_photos` (`id`, `img_id`, `name`, `content`, `status`, `create_time`, `update_time`) VALUES
(1, 6, '222222222', '测试图集内容', 1, 1470716827, 1470731873),
(2, 6, '游戏截图', '游戏截图里包含了各种不同衣服的内容', 1, 1470722632, 1470731884),
(3, 6, '11', '11111', 1, 1470730886, 1470731910),
(4, 6, '1', '1', 1, 1470731801, 1470731923),
(5, 6, '222', '2222', 1, 1470731825, 1470731863),
(6, 6, '111', '1111', 1, 1470731838, 1470731838),
(7, 6, '1112', '2222', 1, 1470731852, 1470731852),
(8, 6, '222', '222222', 1, 1470731938, 1470731938);
...
CREATE TABLE `db_photos_img` (
  `id` int(4) NOT NULL,
  `photos_id` int(10) NOT NULL COMMENT '外键，关联photos表',
...
(1, '/Uploads/Picture/2016-08-09/57a9594f6eba4.jpg', '', '182f633d98a7acc6649e645a98fc4046', '7b6520b77aafa92d5dfcd51a75cadc441fae54e6', 1, 1470716239),
(2, '/Uploads/Picture/2016-08-09/57a95b96a9b05.jpg', '', 'f1684fea1308982663b716799c4d3ff4', 'fd45f66e0c5ae014089679235a3aef79433abcbf', 1, 1470716822),
(3, '/Uploads/Picture/2016-08-09/57a9927b91c7e.jpg', '', 'a7db0ff5c8e9c8510dfaab29a67d6bd8', '82af61b87d3166800bb92ab2aad39e76119a2e76', 1, 1470730875),
(4, '/Uploads/Picture/2016-08-09/57a996174e9ba.jpg', '', '4a345a9af39d8da8f58697489bf3cc86', 'e11b370a051588f96b46d8e294dc868a886bc95d', 1, 1470731799),
(5, '/Uploads/Picture/2016-08-09/57a9963092622.jpg', '', '4f7c35f31d2f1f251d4336ffb521c888', 'f4b2fc50900c5be68bb4913606d3e794faddb5be', 1, 1470731824),
(6, '/Uploads/Picture/2016-08-09/57a9963e3f7f8.jpg', '', '3a6bb918e99034bffd05b3b708c1113a', '8b7e28dad7c4c8a371894fc682a8b74b5367a082', 1, 1470731838);
...
CREATE TABLE `db_ucenter_member` (
...
(1, 'admin', '05cfbe8ff0fb9967361e942686c4391c', 'admin@admin.com', '', 1470712443, 2130706433, 1470712455, 2130706433, 1470712443, 1);
...
CREATE TABLE `db_ucenter_setting` (
...
--
-- Indexes for table `db_action`
--
ALTER TABLE `db_action`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `db_action_log`
--
ALTER TABLE `db_action_log`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `db_addons`
--
ALTER TABLE `db_addons`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `db_attachment`
--
ALTER TABLE `db_attachment`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_record_status` (`record_id`,`status`);

--
-- Indexes for table `db_attribute`
--
ALTER TABLE `db_attribute`
  ADD PRIMARY KEY (`id`),
  ADD KEY `model_id` (`model_id`);

--
-- Indexes for table `db_auth_extend`
--
ALTER TABLE `db_auth_extend`
  ADD UNIQUE KEY `group_extend_type` (`group_id`,`extend_id`,`type`),
  ADD KEY `uid` (`group_id`),
  ADD KEY `group_id` (`extend_id`);

--
-- Indexes for table `db_auth_group`
--
ALTER TABLE `db_auth_group`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `db_auth_group_access`
--
ALTER TABLE `db_auth_group_access`
  ADD UNIQUE KEY `uid_group_id` (`uid`,`group_id`),
  ADD KEY `uid` (`uid`),
  ADD KEY `group_id` (`group_id`);

--
-- Indexes for table `db_auth_rule`
--
ALTER TABLE `db_auth_rule`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `db_channel`
--
ALTER TABLE `db_channel`
  ADD PRIMARY KEY (`id`),
  ADD KEY `pid` (`pid`);
...
--
-- Indexes for table `db_document_article`
--
ALTER TABLE `db_document_article`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `db_document_download`
--
ALTER TABLE `db_document_download`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `db_hooks`
--
ALTER TABLE `db_hooks`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `db_model`
--
ALTER TABLE `db_model`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `db_photos_img`
--
ALTER TABLE `db_photos_img`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `db_picture`
--
ALTER TABLE `db_picture`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `db_ucenter_admin`
--
ALTER TABLE `db_ucenter_admin`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `db_ucenter_app`
--
ALTER TABLE `db_ucenter_app`
  ADD PRIMARY KEY (`id`),
  ADD KEY `status` (`status`);

--
-- Indexes for table `db_ucenter_member`
--
ALTER TABLE `db_ucenter_member`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `db_ucenter_setting`
--
ALTER TABLE `db_ucenter_setting`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `db_url`
--
ALTER TABLE `db_url`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `db_userdata`
--
ALTER TABLE `db_userdata`
